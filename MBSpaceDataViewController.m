...
@interface MBSpaceDataViewController ()

@end

@implementation MBSpaceDataViewController
...
{
    static NSString *CellIdentifier = @"DataCell"; //static means the variable will be kept entire application - start to finish
    ...
    switch (indexPath.row)
    {
        ...
        case 4:
            cell.textLabel.text = @"Lenght of day Hours";
...
{
    return 8; //return number of cells...
}
